...
var l1D95D169_0;l1D95D169_0 = mouse_check_button(mb_left);if (l1D95D169_0){	/// @DnDAction : YoYo Games.Audio.Play_Audio
	...
	/// @DnDHash : 12315CB0
	/// @DnDParent : 1D95D169
	/// @DnDArgument : "xpos" "O_Poichon_CC_8.x"
	/// @DnDArgument : "ypos" "O_Poichon_CC_8.y+100"
	/// @DnDArgument : "objectid" "O_Explosion"
	/// @DnDArgument : "layer" ""Der""
	/// @DnDSaveInfo : "objectid" "O_Explosion"
	instance_create_layer(O_Poichon_CC_8.x, O_Poichon_CC_8.y+100, "Der", O_Explosion);
	...
	instance_create_layer(O_Poichon_CC_8.x, O_Poichon_CC_8.y+100, "timer", O_Poichon_Dead);

	/// @DnDAction : YoYo Games.Instances.Destroy_Instance
	/// @DnDVersion : 1
	/// @DnDHash : 6604AE4D
	/// @DnDApplyTo : {O_Poichon_CC_8}
	/// @DnDParent : 1D95D169
	with(O_Poichon_CC_8) instance_destroy();}